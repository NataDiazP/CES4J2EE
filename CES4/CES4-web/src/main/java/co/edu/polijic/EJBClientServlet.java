...
public class EJBClientServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EJBClientServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EJBClientServlet at " + request.getContextPath() + "</h1>");
            out.println("<h2>Client with ID 1 " + customer.findCustomerById(1) + "</h2>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
