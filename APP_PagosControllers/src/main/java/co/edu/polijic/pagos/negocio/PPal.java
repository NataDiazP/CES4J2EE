...
public class PPal {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * *********************************************
         */
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("appPagos_PU");
...
//        tarjetaJpaController.create(tarjeta);
        ...
        for (Tarjeta tarjeta : tarjetaJpaController.getTarjetaByNmtarjeta("2323232")) {
